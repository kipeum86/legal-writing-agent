...
## Scope
Use this file for generic Korean legal-document defaults. If the document is a Korean legal opinion, legal review opinion, or client memorandum, a configured supplemental reference may override these defaults where that profile specifies opinion-specific typography.
...
## Override Rule
- Korean legal opinions may use opinion-specific typography from a configured supplemental reference
