...
- If the document is a Korean legal opinion, legal review opinion, or client memorandum, load `configured supplemental reference` in addition to `style-guide-kr`
...
6. Load configured supplemental reference when the document is a Korean legal opinion family document
