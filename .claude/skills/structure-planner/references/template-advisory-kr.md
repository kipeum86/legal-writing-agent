...
- For Korean legal opinions, a configured supplemental reference controls where it is more specific than this template
...
- 법령 블록과 판례 인용은 설정된 로컬 supplemental reference의 형식을 우선 적용한다
