...
1. Select convention set: Language + Jurisdiction → base style guide; Document type → template from `/library/templates/`; House style overlay. **한국어 법률의견서인 경우 `configured supplemental reference`를 반드시 읽어 적용.**
