...
- Exception: Korean legal opinions / client memoranda may use the opinion-specific profile from `configured supplemental reference` (2.54 cm margins, 11pt body text, 1.15 spacing)
