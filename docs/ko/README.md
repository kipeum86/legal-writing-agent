...
이 에이전트는 `/library/`를 적극적으로 채워둘수록 결과가 더 좋아집니다.
...
특히 작업하려는 문서와 유사한 샘플 라이팅을 잘 넣어둘수록 결과물이 눈에 띄게 좋아집니다. 팀이 실제로 쓰는 문체와 결과를 맞추고 싶다면, 가장 효과적인 방법은 Library에 좋은 예시 문서를 넣어두는 것입니다.
